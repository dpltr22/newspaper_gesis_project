...
rss <- read_xml("https://www.rtl.de/feeds/politik-inland")
...
write_xml(rss,file = paste0("./newspaper_rss/RTL/RSS_POLITIKINLAND/rtl_rsspolitikinland_",date_file,"_",time_file,".txt"))
