...
rss <- read_xml("https://www.bild.de/rss-feeds/rss-16725492,feed=politik.bild.html")
...
write_xml(rss,file = paste0("./newspaper_rss/Bild/RSS_POLITIK/bild_rsspolitik_",date_file,"_",time_file,".txt"))
...
for(l in 1:length(links)){
  ...
  write_html(article_html, paste0("./newspaper_rss/Bild/HTMLS_POLITIK/",url))
  filepath <- paste0("./newspaper_rss/Bild/HTMLS_POLITIK/",url)
