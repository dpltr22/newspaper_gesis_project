...
# Retrieve links from RSS-Feed
rss <- read_xml("https://www.spiegel.de/schlagzeilen/tops/index.rss")
...
write_xml(rss,file = paste0("./newspaper_rss/Spiegel/RSS_SCHLAGZEILEN/spiegel_rssschlagz_",date_file,"_",time_file,".txt"))
...
for(l in 1:length(links)){
  ...
  if(l == 1){
    ...
    # Add needed Cookies (Login Information)
