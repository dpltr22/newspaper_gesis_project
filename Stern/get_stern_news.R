...
rss <- read_xml("https://www.stern.de/feed/standard/alle-nachrichten/")
...
write_xml(rss,file = paste0("./newspaper_rss/Stern/RSS_NEWS/stern_rssnews_",date_file,"_",time_file,".txt"))
