...
rss <- read_xml("http://www.stern.de/feed/standard/politik/")
...
write_xml(rss,file = paste0("./newspaper_rss/Stern/RSS_POLITIK/stern_rsspolitik_",date_file,"_",time_file,".txt"))
